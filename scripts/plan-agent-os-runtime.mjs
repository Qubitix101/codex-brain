...
const result = {
  ...
  next_step: "Create docs/agent-os-runtime-plan.md before agent network, Agentic Zero Trust, and capability/access mapping. Define runtime ownership, memory/tool/identity/trace/governance/recovery/budget controls for the first agentic slice."
};
...
lines.push("");
lines.push("Fill `docs/agent-os-runtime-plan.md` after `docs/agent-engineering-audit.md` and `docs/skill-inventory.md`. Do not map agent network, Agentic Zero Trust, capability/access, or approve the Build Plan for L3+ systems until scheduling, memory, tool sandboxing, identity, traces, governance, recovery, budgets, agent roles, and human control are explicit.");
