...
if (!state.gates?.agentic_zero_trust) warnings.push("state.gates.agentic_zero_trust is missing; bootstrap from the latest Codex Brain template when agentic security planning matters.");
