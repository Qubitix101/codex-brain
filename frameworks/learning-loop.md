...
- update `frameworks/skill-factory.md`
- add or revise entries in `catalogs/agent-engineering-catalog.json`
- update `templates/shared/agent-engineering-audit.template.md`
